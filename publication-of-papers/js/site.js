...
ff.$w.load(function(){
	if(window.location.href.indexOf('friday') > -1) {
		l('fri');
		ff.$b.removeClass('about sat');
		ff.$b.addClass('fri lock');
	...
	} else if (window.location.href.indexOf('saturday') > -1) {
		l('sat');
		ff.$b.removeClass('about fri');
		ff.$b.addClass('sat lock');
...
var camera = new THREE.PerspectiveCamera( 85, (window.innerWidth / 2) / window.innerHeight, 0.1, 1000 );
